...
(function(){
  ...
  function fitToScreen(){
    // Slight padding so it doesn't touch the browser bars
    var scale = Math.min(window.innerWidth / BASE_W, window.innerHeight / BASE_H) * 0.98;
    // Clamp (avoid too tiny / too huge)
    scale = Math.max(0.80, Math.min(1.60, scale));
